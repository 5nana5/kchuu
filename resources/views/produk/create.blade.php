...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.btn-edit-product')
        ...
        button.addEventListener('click', function () {
            ...
            productEditForm
                .querySelector('[name="nama_produk"]')
                .value = this.dataset.nama;


            productEditForm
                .querySelector('[name="kategori_id"]')
                .value = this.dataset.kategori;


            productEditForm
                .querySelector('[name="harga"]')
                .value = this.dataset.harga;


            productEditForm
                .querySelector('[name="stok"]')
                .value = this.dataset.stok;


            productEditForm
                .querySelector('[name="deskripsi"]')
                .value = this.dataset.deskripsi;
